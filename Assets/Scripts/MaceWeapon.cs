...
public class MaceWeapon : MeleeWeapon
{
    ...
    protected override void OnFire(Transform _targetTransform)
    {
        ...
        bullet.GetComponent<EffectBullet>().Fire(DamageManager.Instance.Critical(GetComponentInParent<Player>(), Damage, out bool isCritical), CurCount, Vector3.zero, knockBackPower, CurDuration, isCritical);
