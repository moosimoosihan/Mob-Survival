...
namespace olimsko
{
    [CustomEditor(typeof(UIToggle), true), CanEditMultipleObjects]
    public class UIToggleEditor : ToggleEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField($"UIToggle", style, GUILayout.ExpandWidth(true));
            ...
            EditorGUILayout.PropertyField(m_DicProperty["m_UITransition"]);
